...
<div align="center">
  <a href="https://github.com/Matta-Labs/camera-mounts">
    <img src="images/mattascope-s1.png" alt="Logo" width="400" height="300">
  </a>

<h3 align="center">Mount: MattaScope S1 Endoscope Mount </h3>

  <p align="center">
    This is a simple, one-piece mount to allow a cheap, off-the-shelf endoscope to work as a nozzle camera for Creality Ender S1 printers (or printer with a Sprite Extruder)
    <br />
    <br />
...
<b>Compatible Printer:</b> Creality Ender S1/S1 Pro (or anything with a Sprite Extruder)
<br />
<br />
...
<p>
  ...
  1. Slice with normal or tree supports, with the mounting plate flat against the bed.
...
<p>
  ...
  <div><img src="images/clip.png" alt="Clipping endoscope into mount" width="400"></div>
  2. Screw the mount onto the mounting holes on the right hand side of the extruder
  <div><img src="images/in-place.png" alt="Mount in place" width="400"></div>
  <br />
</p>

Set focus with ```sudo v4l2-ctl --set-ctrl focus_automatic_continuous=0``` & 
